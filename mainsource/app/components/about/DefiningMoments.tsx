        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            ...
            <div className="pt-2 sm:pt-3 lg:pt-4">
              <button onClick={()=>router.push('/services')} className="group relative bg-[#1b75bb] text-white px-6 sm:px-8 py-3 sm:py-4 text-xs sm:text-sm font-medium hover:bg-[#027cc2] transition-all duration-300 uppercase rounded-lg overflow-hidden shadow-lg hover:shadow-xl transform hover:scale-105 cursor-pointer">
