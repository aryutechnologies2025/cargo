...
const CTA = () => {
  ...
  return (
    <section className="py-10 sm:py-12 md:py-14 bg-linear-to-r from-[#057dc3] to-[#0469a5]">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="group border-2 border-white text-white px-6 sm:px-7 md:px-8 py-3 sm:py-4 rounded-full font-bold text-sm sm:text-base md:text-lg hover:bg-white hover:text-[#057dc3] transition-all duration-300 cursor-pointer"
            >
              Explore Services
            </motion.button>
          </div>
