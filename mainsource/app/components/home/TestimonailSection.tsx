...
const TestimonialSection = () => {
  ...
  return (
    <section className="w-full bg-linear-to-b from-white to-gray-50 overflow-hidden  py-5 sm:py-9 md:py-14">
      {/* Section Header */}
      <motion.div
        initial="hidden"
        whileInView="visible"
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 md:p-10">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="relative group mb-4">
                      <div className="absolute inset-0 bg-linear-to-r from-[#057dc3] to-[#0469a5] rounded-full blur-lg opacity-0 group-hover:opacity-60 transition-opacity duration-500" />
                      <Image
              ...
              >
                <span
                  className={`absolute inset-0 rounded-full transition-all duration-300 ${
                    currentTestimonial === index
                      ? "bg-linear-to-r from-[#057dc3] to-[#0469a5]"
