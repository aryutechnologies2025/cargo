...
const BlogCard = ({ post, index }: { post: BlogPost; index: number }) => (
  ...
  >
    ...
    <div className="p-5 md:p-6">
      ...
      {/* Hover Border Effect */}
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-[#057dc3] to-[#fdc300] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
    </div>
  </motion.div>
);
  ...
  return (
    <section className="w-full bg-linear-to-b from-white to-gray-50 overflow-hidden px-5 sm:px-7 md:px-16 lg:px-32 py-5 sm:py-9 md:py-14">
      ...
      >
        <Link
          href="/blog"
          className="group inline-flex items-center gap-3 bg-linear-to-r from-[#057dc3] to-[#0469a5] text-white px-8 py-4 rounded-xl font-semibold text-sm hover:shadow-xl hover:scale-105 transition-all duration-300"
        >
