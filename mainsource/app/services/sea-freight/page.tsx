...
//           >
//             <GiShipBow className="text-[#027cc2]" />
...
//               <Link
//                 href="/contact"
//                 className="group inline-flex items-center gap-2 bg-[#027cc2] text-white px-8 py-4 rounded-lg font-bold hover:bg-[#034a8f] h-full transition-all shadow-lg hover:shadow-xl"
//               >
...
//                 className="group inline-flex items-center gap-2 border-2 border-[#027cc2] text-[#027cc2] px-8 py-4 h-full rounded-lg font-semibold hover:bg-[#027cc2] hover:text-white transition-all"
//               >
//                 <span>Track Shipment</span>
//                 <PiArrowCircleRight className="group-hover:translate-x-1 transition-transform" />
//               </Link>
//             </motion.div>
//           </motion.div>
//         </motion.div>
...
//         >
//           <span className="text-[#027cc2] font-semibold text-sm uppercase tracking-wider">Global Network</span>
...
//           >
//             <div className="w-full h-64 bg-gradient-to-r from-[#027cc2]/5 via-transparent to-[#027cc2]/5 rounded-full blur-3xl" />
//           </motion.div>
...
//               >
//                 <div className="bg-gray-50 p-6 rounded-2xl text-center hover:bg-[#027cc2] hover:text-white transition-all duration-300 border border-gray-100 hover:border-transparent shadow-sm hover:shadow-xl">
//                   <motion.div
//                     animate={{ rotate: [0, 10, -10, 0] }}
//                     transition={{ duration: 2, delay: index * 0.2, repeat: Infinity }}
//                   >
//                     <region.icon className="text-4xl text-[#027cc2] group-hover:text-white mx-auto mb-3" />
//                   </motion.div>
//                   <h4 className="font-bold mb-1">{region.name}</h4>
//                   <p className="text-sm text-gray-500 group-hover:text-white/80">{region.routes}</p>
//                 </div>
//               </motion.div>
//             ))}
//           </div>
...
//             >
//               <PiAnchor className="text-sm" />
//               <span className="text-xs font-semibold">FMC LICENSED</span>
//             </motion.div>
