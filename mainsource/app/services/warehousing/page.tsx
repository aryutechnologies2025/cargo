...
//             ease: "linear",
//           }}
//           className="absolute top-20 -right-40 w-96 h-[450px] bg-[#027cc2]/10 rounded-full blur-3xl"
//         />
...
//             ease: "linear",
//           }}
//           className="absolute bottom-20 -left-40 w-96 h-[450px] bg-[#027cc2]/10 rounded-full blur-3xl"
//         />
...
//             className="inline-flex items-center gap-2 bg-[#027cc2]/10 text-[#027cc2] px-4 py-2 rounded-full mb-6 border border-[#027cc2]/20"
//           >
//             <PiWarehouse className="text-[#027cc2]" />
...
//               className="block text-transparent bg-clip-text bg-gradient-to-r from-[#027cc2] to-[#034a8f]"
//             >
//               & Distribution
//             </motion.span>
//           </motion.h1>
...
//               <Link
//                 href="/contact"
//                 className="group inline-flex items-center gap-2 bg-[#027cc2] text-white px-8 py-4 rounded-lg font-bold hover:bg-[#034a8f] transition-all shadow-lg hover:shadow-xl"
//               >
...
//   return (
//     <section ref={containerRef} className="py-16 bg-white relative -mt-20 z-20">
...
//               }}
//               className="bg-white rounded-2xl p-6 text-center shadow-xl hover:shadow-2xl transition-all border border-gray-100"
//             >
//               <div className="w-16 h-16 mx-auto bg-gradient-to-br from-[#027cc2] to-[#034a8f] rounded-2xl flex items-center justify-center text-white mb-4">
...
//               className="inline-flex items-center gap-2 bg-[#027cc2]/10 text-[#027cc2] px-4 py-2 rounded-full mb-4"
//             >
...
//                   >
//                     <PiCheckCircle className="text-[#027cc2] text-xl flex-shrink-0" />
//                   </motion.div>
...
//         >
//           <span className="text-[#027cc2] font-semibold text-sm uppercase tracking-wider">
//             FACILITY FEATURES
//           </span>
...
//               whileHover={{
//                 y: -10,
//                 boxShadow: "0 30px 60px rgba(2,124,194,0.2)",
//               }}
...
//                 className="absolute inset-0 bg-gradient-to-br from-[#027cc2]/5 to-transparent rounded-2xl"
//               />

//               <motion.div
//                 whileHover={{ scale: 1.1, rotate: 5 }}
//                 className={`w-14 h-14 bg-gradient-to-r ${feature.color} rounded-xl flex items-center justify-center text-white mb-4 shadow-lg relative z-10`}
//               >
//                 <feature.icon className="text-2xl" />
//               </motion.div>
...
//                     >
//                       <PiCheckCircle className="text-[#027cc2] text-xs flex-shrink-0" />
//                       <span>{detail}</span>
//                     </motion.li>
//                   ))}
//                 </ul>
...
//               >
//                 <div className="bg-gray-50 p-6 rounded-2xl text-center hover:bg-[#027cc2] hover:text-white transition-all duration-300 border border-gray-100 hover:border-transparent shadow-sm hover:shadow-xl h-full flex flex-col">
//                   <motion.div
//                     animate={{ 
//                       y: [0, -5, 0],
//                       rotate: [0, 5, -5, 0] 
...
//                     }}
//                   >
//                     <location.icon className="text-4xl text-[#027cc2] group-hover:text-white mx-auto mb-3" />
//                   </motion.div>
                  
//                   <h4 className="font-bold mb-1 text-gray-900 group-hover:text-white">
//                     {location.name}
//                   </h4>
                  
//                   <p className="text-sm text-gray-600 group-hover:text-white/90 mb-2">
//                     {location.region}
//                   </p>
                  
//                   <p className="text-sm font-semibold text-[#027cc2] group-hover:text-white mb-2">
//                     {location.size}
//                   </p>
...
//         >
//           <div className="p-4">
//             <div className="text-3xl font-bold text-[#027cc2]">12</div>
//             <div className="text-sm text-gray-600">Strategic Locations</div>
//           </div>
//           <div className="p-4">
//             <div className="text-3xl font-bold text-[#027cc2]">2.5M+</div>
//             <div className="text-sm text-gray-600">Total Sq Ft</div>
//           </div>
//           <div className="p-4">
//             <div className="text-3xl font-bold text-[#027cc2]">48</div>
//             <div className="text-sm text-gray-600">Major Markets</div>
//           </div>
//           <div className="p-4">
//             <div className="text-3xl font-bold text-[#027cc2]">24/7</div>
...
//             className="absolute top-24 left-0 right-0 h-1 bg-gradient-to-r from-[#027cc2] via-[#fdc300] to-[#027cc2] hidden lg:block origin-left"
//           />
...
//                     repeat: Infinity,
//                   }}
//                   className="w-16 h-16 bg-[#027cc2] rounded-2xl flex items-center justify-center text-white mx-auto mb-4 relative z-10 shadow-lg"
//                 >
//                   <step.icon className="text-2xl" />
//                 </motion.div>

//                 <div className="text-center mb-3">
//                   <span className="text-xs font-mono text-[#027cc2] bg-[#027cc2]/10 px-2 py-1 rounded-full">
//                     {step.phase}
//                   </span>
//                 </div>
...
// function CTASection() {
//   return (
//     <section className="relative py-16 overflow-hidden bg-gradient-to-r from-[#027cc2] to-[#034a8f]">
...
//         animate={{ rotate: -360 }}
//         transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
//         className="absolute bottom-0 right-0 w-64 h-64 bg-[#fdc300]/10 rounded-full blur-3xl"
//       />
...
//         className="absolute left-[10%] top-1/2 transform -translate-y-1/2 text-white/5 hidden lg:block"
//       >
//         <PiWarehouse className="text-6xl" />
//       </motion.div>
      
//       <motion.div
//         animate={{ y: [0, 10, 0] }}
//         transition={{ duration: 5, repeat: Infinity }}
//         className="absolute right-[10%] top-1/2 transform -translate-y-1/2 text-white/5 hidden lg:block"
//       >
...
//               className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full mb-3 border border-white/30"
//             >
//               <PiClock className="text-sm" />
//               <span className="text-xs font-semibold">QUOTE IN UNDER 1 HOUR</span>
//             </motion.div>
...
//               <Link
//                 href="/contact"
//                 className="inline-flex items-center justify-center gap-2 bg-white text-[#027cc2] px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl text-base min-w-[160px]"
//               >
...
//               <Link
//                 href="/contact"
//                 className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-[#027cc2] transition-all text-base min-w-[160px]"
//               >
