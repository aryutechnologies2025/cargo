...
const termsSections = [
    {
      ...
      icon: <FaFileSignature className="text-[#1874c1]" />,
      content:
    ...
    {
      title: "Insurance",
      icon: <FaShieldAlt className="text-[#1874c1]" />,
      content:
    ...
    {
      title: "Warranties",
      icon: <MdGavel className="text-[#1874c1]" />,
      content: "We make no warranties, express or implied.",
    },
    {
      title: "Your Obligation",
      icon: <MdAssignment className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdWarning className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <FaBoxOpen className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdAccessTime className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdSecurity className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdPayment className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdReport className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdCancel className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdDescription className="text-[#1874c1]" />,
      content:
    ...
    },
    {
      ...
      icon: <MdPeople className="text-[#1874c1]" />,
      content:
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            <div className="w-12 h-0.5 bg-[#1874c1] rounded-full"></div>
            <MdGavel className="text-[#1874c1] text-xl animate-pulse" />
            <div className="w-12 h-0.5 bg-[#1874c1] rounded-full"></div>
          </div>
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#2A2A2A] mb-3">
            ...
            <span className="text-[#1874c1] relative inline-block">
              ...
              <div className="absolute -bottom-2 left-0 w-full h-0.5 bg-linear-to-r from-transparent via-[#1874c1] to-transparent"></div>
            </span>
          </h1>
        ...
        <div className="flex flex-col gap-4 sm:gap-5 md:gap-6">
          {termsSections.map((section, index) => (
            ...
            >
              {/* Left accent border */}
              <div
                className={`absolute left-0 top-0 bottom-0 w-1 bg-[#1874c1] transform transition-all duration-500 `}
              />
              ...
              <div className="p-4 sm:p-5 md:p-6 border-b border-gray-100">
                <div className="flex items-center gap-3">
                  {/* Icon container */}
                  <div
                    className={`relative p-2 sm:p-3 rounded-lg bg-[#1874c1]/5 transition-all duration-300 group-hover:bg-[#1874c1]/10 `}
                  >
                    <div className="absolute inset-0 bg-[#1874c1]/20 rounded-lg blur-md scale-0 group-hover:scale-150 transition-transform duration-300 opacity-0 group-hover:opacity-100" />
                  ...
                  <h2 className="text-base sm:text-lg md:text-xl font-bold text-[#2A2A2A] transition-all duration-300 group-hover:text-[#1874c1]">
                    {section.title}
                  </h2>
                </div>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-[#1874c1] to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
            </div>
          ))}
        </div>
